 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/user/workspace_v6_1/t1/Debug/configPkg/package/cfg/empty_min_pem3");
...
#endif
#endif
const ti_sysbios_hal_Hwi_Handle mytimerhwi = (ti_sysbios_hal_Hwi_Handle)((ti_sysbios_hal_Hwi_Handle)&ti_sysbios_hal_Hwi_Object__table__V[0]);
