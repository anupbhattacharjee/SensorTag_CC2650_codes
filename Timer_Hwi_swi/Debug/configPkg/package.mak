...
.dlls,em3 .dlls: Timer_Hwi_swi.pem3

-include package/cfg/Timer_Hwi_swi_pem3.mak
-include package/cfg/Timer_Hwi_swi_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Timer_Hwi_swi_pem3.dep
endif
Timer_Hwi_swi.pem3: package/cfg/Timer_Hwi_swi_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
Timer_Hwi_swi.pem3 package/cfg/Timer_Hwi_swi_pem3.c: .libraries,em3
endif

package/cfg/Timer_Hwi_swi_pem3.c package/cfg/Timer_Hwi_swi_pem3.h package/cfg/Timer_Hwi_swi_pem3.xdl: override _PROG_NAME := Timer_Hwi_swi.xem3
package/cfg/Timer_Hwi_swi_pem3.c: package/cfg/Timer_Hwi_swi_pem3.cfg
package/cfg/Timer_Hwi_swi_pem3.xdc.inc: package/cfg/Timer_Hwi_swi_pem3.xdl
package/cfg/Timer_Hwi_swi_pem3.xdl package/cfg/Timer_Hwi_swi_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/Timer_Hwi_swi_pem3.cfg
	-$(RM) package/cfg/Timer_Hwi_swi_pem3.dep
	-$(RM) package/cfg/Timer_Hwi_swi_pem3.c
	-$(RM) package/cfg/Timer_Hwi_swi_pem3.xdc.inc

clean,em3::
	-$(RM) Timer_Hwi_swi.pem3
.executables,em3 .executables: Timer_Hwi_swi.xem3

Timer_Hwi_swi.xem3: |Timer_Hwi_swi.pem3

-include package/cfg/Timer_Hwi_swi.xem3.mak
Timer_Hwi_swi.xem3: package/cfg/Timer_Hwi_swi_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/Timer_Hwi_swi_pem3.oem3   package/cfg/Timer_Hwi_swi_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
Timer_Hwi_swi.xem3: export C_DIR=
Timer_Hwi_swi.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
Timer_Hwi_swi.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

Timer_Hwi_swi.test test,em3 test: Timer_Hwi_swi.xem3.test

Timer_Hwi_swi.xem3.test:: Timer_Hwi_swi.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Timer_Hwi_swi.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Timer_Hwi_swi.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,Timer_Hwi_swi.xem3,*)


clean:: clean,em3

clean,em3::
	-$(RM) Timer_Hwi_swi.xem3
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
Timer_Hwi_swi_pem3.oem3,copy : package/cfg/Timer_Hwi_swi_pem3.oem3
Timer_Hwi_swi_pem3.sem3,copy : package/cfg/Timer_Hwi_swi_pem3.sem3
