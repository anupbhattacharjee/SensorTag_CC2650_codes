...
/* --> countdown */
extern xdc_Void countdown(xdc_UArg);
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[5996];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/user/workspace_v6_1/Timer_Hwi_swi/Debug/configPkg/package/cfg/Timer_Hwi_swi_pem3");
...
ti_sysbios_family_arm_m3_Hwi_Object__ ti_sysbios_family_arm_m3_Hwi_Object__table__V[2] = {
    {/* instance#0 */
        0,
        ((xdc_UArg)(0x0)),  /* arg */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)countdown)),  /* fxn */
        ((xdc_UArg)(0x3)),  /* irp */
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x176c;
...
#endif
#endif
const ti_sysbios_hal_Hwi_Handle myHwi = (ti_sysbios_hal_Hwi_Handle)((ti_sysbios_hal_Hwi_Handle)&ti_sysbios_hal_Hwi_Object__table__V[0]);
