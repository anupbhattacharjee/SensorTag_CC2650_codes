...
.dlls,em3 .dlls: Task_sem_blink.pem3

-include package/cfg/Task_sem_blink_pem3.mak
-include package/cfg/Task_sem_blink_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Task_sem_blink_pem3.dep
endif
Task_sem_blink.pem3: package/cfg/Task_sem_blink_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
Task_sem_blink.pem3 package/cfg/Task_sem_blink_pem3.c: .libraries,em3
endif

package/cfg/Task_sem_blink_pem3.c package/cfg/Task_sem_blink_pem3.h package/cfg/Task_sem_blink_pem3.xdl: override _PROG_NAME := Task_sem_blink.xem3
package/cfg/Task_sem_blink_pem3.c: package/cfg/Task_sem_blink_pem3.cfg
package/cfg/Task_sem_blink_pem3.xdc.inc: package/cfg/Task_sem_blink_pem3.xdl
package/cfg/Task_sem_blink_pem3.xdl package/cfg/Task_sem_blink_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/Task_sem_blink_pem3.cfg
	-$(RM) package/cfg/Task_sem_blink_pem3.dep
	-$(RM) package/cfg/Task_sem_blink_pem3.c
	-$(RM) package/cfg/Task_sem_blink_pem3.xdc.inc

clean,em3::
	-$(RM) Task_sem_blink.pem3
.executables,em3 .executables: Task_sem_blink.xem3

Task_sem_blink.xem3: |Task_sem_blink.pem3

-include package/cfg/Task_sem_blink.xem3.mak
Task_sem_blink.xem3: package/cfg/Task_sem_blink_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/Task_sem_blink_pem3.oem3   package/cfg/Task_sem_blink_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
Task_sem_blink.xem3: export C_DIR=
Task_sem_blink.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
Task_sem_blink.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

Task_sem_blink.test test,em3 test: Task_sem_blink.xem3.test

Task_sem_blink.xem3.test:: Task_sem_blink.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Task_sem_blink.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Task_sem_blink.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,Task_sem_blink.xem3,*)


clean:: clean,em3

clean,em3::
	-$(RM) Task_sem_blink.xem3
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
Task_sem_blink_pem3.oem3,copy : package/cfg/Task_sem_blink_pem3.oem3
Task_sem_blink_pem3.sem3,copy : package/cfg/Task_sem_blink_pem3.sem3
