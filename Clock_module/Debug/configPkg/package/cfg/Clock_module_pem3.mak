...
package/cfg/Clock_module_pem3.oem3: export C_DIR=
package/cfg/Clock_module_pem3.oem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
package/cfg/Clock_module_pem3.oem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

package/cfg/Clock_module_pem3.sem3: | .interfaces
package/cfg/Clock_module_pem3.sem3: package/cfg/Clock_module_pem3.c package/cfg/Clock_module_pem3.mak
	@$(RM) $@.dep
	$(RM) $@
	@$(MSG) clem3 -n $< ...
...
package/cfg/Clock_module_pem3.sem3: export C_DIR=
package/cfg/Clock_module_pem3.sem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
package/cfg/Clock_module_pem3.sem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

clean,em3 ::
	-$(RM) package/cfg/Clock_module_pem3.oem3
	-$(RM) package/cfg/Clock_module_pem3.sem3

Clock_module.pem3: package/cfg/Clock_module_pem3.oem3 package/cfg/Clock_module_pem3.mak

clean::
	-$(RM) package/cfg/Clock_module_pem3.mak
