...
.dlls,em3 .dlls: Clock_module.pem3

-include package/cfg/Clock_module_pem3.mak
-include package/cfg/Clock_module_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Clock_module_pem3.dep
endif
Clock_module.pem3: package/cfg/Clock_module_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
Clock_module.pem3 package/cfg/Clock_module_pem3.c: .libraries,em3
endif

package/cfg/Clock_module_pem3.c package/cfg/Clock_module_pem3.h package/cfg/Clock_module_pem3.xdl: override _PROG_NAME := Clock_module.xem3
package/cfg/Clock_module_pem3.c: package/cfg/Clock_module_pem3.cfg
package/cfg/Clock_module_pem3.xdc.inc: package/cfg/Clock_module_pem3.xdl
package/cfg/Clock_module_pem3.xdl package/cfg/Clock_module_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/Clock_module_pem3.cfg
	-$(RM) package/cfg/Clock_module_pem3.dep
	-$(RM) package/cfg/Clock_module_pem3.c
	-$(RM) package/cfg/Clock_module_pem3.xdc.inc

clean,em3::
	-$(RM) Clock_module.pem3
.executables,em3 .executables: Clock_module.xem3

Clock_module.xem3: |Clock_module.pem3

-include package/cfg/Clock_module.xem3.mak
Clock_module.xem3: package/cfg/Clock_module_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/Clock_module_pem3.oem3   package/cfg/Clock_module_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
Clock_module.xem3: export C_DIR=
Clock_module.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
Clock_module.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

Clock_module.test test,em3 test: Clock_module.xem3.test

Clock_module.xem3.test:: Clock_module.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Clock_module.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Clock_module.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,Clock_module.xem3,*)


clean:: clean,em3

clean,em3::
	-$(RM) Clock_module.xem3
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
Clock_module_pem3.oem3,copy : package/cfg/Clock_module_pem3.oem3
Clock_module_pem3.sem3,copy : package/cfg/Clock_module_pem3.sem3
