...
.dlls,em3 .dlls: Button_Hwi.pem3

-include package/cfg/Button_Hwi_pem3.mak
-include package/cfg/Button_Hwi_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Button_Hwi_pem3.dep
endif
Button_Hwi.pem3: package/cfg/Button_Hwi_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
Button_Hwi.pem3 package/cfg/Button_Hwi_pem3.c: .libraries,em3
endif

package/cfg/Button_Hwi_pem3.c package/cfg/Button_Hwi_pem3.h package/cfg/Button_Hwi_pem3.xdl: override _PROG_NAME := Button_Hwi.xem3
package/cfg/Button_Hwi_pem3.c: package/cfg/Button_Hwi_pem3.cfg
package/cfg/Button_Hwi_pem3.xdc.inc: package/cfg/Button_Hwi_pem3.xdl
package/cfg/Button_Hwi_pem3.xdl package/cfg/Button_Hwi_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/Button_Hwi_pem3.cfg
	-$(RM) package/cfg/Button_Hwi_pem3.dep
	-$(RM) package/cfg/Button_Hwi_pem3.c
	-$(RM) package/cfg/Button_Hwi_pem3.xdc.inc

clean,em3::
	-$(RM) Button_Hwi.pem3
.executables,em3 .executables: Button_Hwi.xem3

Button_Hwi.xem3: |Button_Hwi.pem3

-include package/cfg/Button_Hwi.xem3.mak
Button_Hwi.xem3: package/cfg/Button_Hwi_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/Button_Hwi_pem3.oem3   package/cfg/Button_Hwi_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
Button_Hwi.xem3: export C_DIR=
Button_Hwi.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
Button_Hwi.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

Button_Hwi.test test,em3 test: Button_Hwi.xem3.test

Button_Hwi.xem3.test:: Button_Hwi.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Button_Hwi.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Button_Hwi.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,Button_Hwi.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Button_Hwi_pem3.oem3,copy : package/cfg/Button_Hwi_pem3.oem3
Button_Hwi_pem3.sem3,copy : package/cfg/Button_Hwi_pem3.sem3
