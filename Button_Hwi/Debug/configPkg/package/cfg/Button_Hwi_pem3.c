...
/* --> button_press */
extern xdc_Void button_press(xdc_UArg);
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/user/workspace_v6_1/Button_Hwi/Debug/configPkg/package/cfg/Button_Hwi_pem3");
...
ti_sysbios_family_arm_m3_Hwi_Object__ ti_sysbios_family_arm_m3_Hwi_Object__table__V[2] = {
    {/* instance#0 */
        0,
        ((xdc_UArg)(0x0)),  /* arg */
        ((xdc_Void(*)(xdc_UArg))((xdc_Fxn)button_press)),  /* fxn */
        ((xdc_UArg)(0x3)),  /* irp */
